...
* Teams can be split into subsystems
* Board: a Trello style Kanban board per organisation with drag and drop, filters by team, subsystem and assignee, due dates and card details
